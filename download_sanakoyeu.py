# Downloads the pretrained VGG model that Sanakoyeu et al. used to calculate deception score.
# This model classifies paintings into artists 
# Credit for this code goes to Sanakoyeu et al: https://github.com/CompVis/adaptive-style-transfer/blob/master/evaluation/download_evaluation_data.py
